...
var FAR={en:"\u0627\u0644\u0625\u0646\u062c\u0644\u064a\u0632\u064a\u0629 A0-C2",tr:"\u0627\u0644\u062a\u0631\u0643\u064a\u0629 A0-C1",zh:"\u0627\u0644\u0635\u064a\u0646\u064a\u0629 A0-C1"};
...
function getL(){return document.documentElement.getAttribute("data-lang")||"ar";}
function isAr(){return getL()==="ar";}
...
function render(){
  ...
  if(!prods.length){
    grid.innerHTML="<div class=\"no-results\"><i class=\"ti ti-search\"></i><p>"+t("\u0644\u0627 \u062a\u0648\u062c\u062f \u062f\u0631\u0648\u0633","No courses found")+"</p></div>";
    return;
  }
  grid.innerHTML=prods.map(function(p){
    var ico=IMAP[p.s]||"ti-book-2";
    var col=CMAP[p.l]||"#534AB7";
    var title=isAr()?p.ar:p.en;
    var sk=isAr()?(SAR[p.s]||p.s):(SEN[p.s]||p.s);
    var badge="";
    if(p.b==="hot")badge="<span class=\"pbadge badge-hot\">"+t("\u0627\u0644\u0623\u0643\u062b\u0631 \u0645\u0628\u064a\u0639\u0627\u064b","Best Seller")+"</span>";
    else if(p.b==="new")badge="<span class=\"pbadge badge-new\">"+t("\u062c\u062f\u064a\u062f","New")+"</span>";
    else if(p.b==="free")badge="<span class=\"pbadge badge-free\">"+t("\u0645\u062c\u0627\u0646\u064a","Free")+"</span>";
    var FREE=t("\u0645\u062c\u0627\u0646\u064a","Free");
    var ADD=t("\u0623\u0636\u0641","Add");
    var GET=t("\u062d\u0645\u0651\u0644","Get");
...
function dlFree(){showToast(t("\u062c\u0627\u0631\u064d...","Downloading..."));}
var CART={
...
function addProd(p){
  CART.add({id:p.id,title:isAr()?p.ar:p.en,price:p.p||0,skill:p.s,lang:p.l});
  showToast(t("\u062a\u0645\u062a \u0627\u0644\u0625\u0636\u0627\u0641\u0629 \u2713","Added to cart \u2713"));
}
function updateCartUI(){
  var lang=getL();var items=CART.get();
  ...
  if(!body)return;
  if(!items.length){
    body.innerHTML="<div class=\"cempty\"><i class=\"ti ti-shopping-cart\"></i><span>"+t("\u0633\u0644\u062a\u0643 \u0641\u0627\u0631\u063a\u0629","Cart empty")+"</span></div>";
...
function showToast(msg){
  var el=document.getElementById("toast"),m=document.getElementById("toastMsg");
  if(el&&m){m.textContent=msg;el.classList.add("show");clearTimeout(_tt);_tt=setTimeout(function(){el.classList.remove("show");},2800);}
}
...
function initNav(){
  ...
  if(token&&user){
    ...
    var dashTxt=isAr()?"\u0644\u0648\u062d\u062a\u064a":"Dashboard";
    re.innerHTML=user.role==="admin"?"<i class=\"ti ti-settings\"></i> Admin":"<i class=\"ti ti-layout-dashboard\"></i> "+dashTxt;
...
function initApp(){
  if(window.LINGUA_DB&&window.LINGUA_DB.length){
    ...
    if(g)g.innerHTML="<div class=\"no-results\"><p>Database error. Refresh.</p></div>";
    return;
  }
  document.querySelectorAll(".lfbtn").forEach(function(b){
    var oc=b.getAttribute("onclick")||"";
    var m=oc.match(/filterLang\(.(\w+)./);
